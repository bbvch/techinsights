...
This iterated a couple times, and included colleagues using the same solution. Then it eventually grew into a full blown course on how to use this tooling for agentic-coding.
