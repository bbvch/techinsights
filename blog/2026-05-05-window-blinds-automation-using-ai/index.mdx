...
description: "Building a home-automation system with AI was fast. Making it survive contact with real weather, real hardware, and real edge cases was the actual work. What I learned about where AI helps and where judgment still has to come from you."
...
The data had an odd feature, though. The radiation reading sat roughly flat for a stretch of the early morning and then jumped — a sharp step up at a moment when the sun's angle had barely changed. The explanation came back quickly and confidently: something was clearing — a horizon haze layer, a neighbouring building, a tree, a ridgeline — and at that instant the attenuated early light gave way to the full direct beam. Don't chase it with a steeper curve, the reasoning went; the angle at which that happens shifts with the season and the weather, so a formula fitted to today's break-through point would simply be wrong on another morning.

It was a clean explanation, and I didn't buy it. The reading wasn't coming from a sensor on my windowsill. It was a MeteoSwiss station — sited, calibrated, and maintained by people whose job is precisely to make sure nothing nearby shades the instrument. An obstruction in front of *that* was the one thing I could rule out by knowing where the number came from. The explanation was plausible, and it didn't survive a single fact about the world that produced the data.
...
Same tool, more than once. Sometimes it refused my easy fix and was right to. Sometimes it accepted all of them, in order, and I let it. The difference between those sessions wasn't the model. It was whether I'd brought a fixed point of my own — and on the days I hadn't, nothing in the exchange announced that it was missing.


## Further Reading

* [data.geo.admin.ch / SwissMetNet / Automatic weather stations](https://data.geo.admin.ch/browser/index.html#/collections/ch.meteoschweiz.ogd-smn)
