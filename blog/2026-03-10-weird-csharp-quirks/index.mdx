...
_BUT_: claude (or any other LLM) does help enormously here.
...
I do agree that the way ArchUnitNET wants you to specify some rules, arent really intuitive. So NetArchTest might be a alternative, _BUT_: i have not tried it out myself.
